...
void SolverImpOmpScatter::resetGrid(System& system)
{
...
void SolverImpOmpScatter::transferP2G(System& system, const SimParameters& parameters)
{
...
void SolverImpOmpScatter::p2gSingleBlock(System& system, int bi)
{
	// get block
...
void SolverImpOmpScatter::computeGrid(System& system, const SimParameters& parameters)
{
	// for all particles
	//      compute VPFT (explicit)
	//
...
void SolverImpOmpScatter::transferG2P(System& system, const SimParameters& parameters)
{
	// loop through part
#pragma omp parallel for schedule(dynamic)
...
void SolverImpOmpScatter::computeParticle(System& system, const SimParameters& parameters)
{
